...
import { consomeCota, MAX_INSTANCIAS, APP_CHECK_EXIGIDO } from './cota'

// A Assistente (resumo diário no WhatsApp e resposta pelo mesmo canal) vive em ./assistente
// — arquivo próprio porque é o único caminho da IA que roda SEM ninguém na tela, e as
// garantias dele são outras: fuso do cliente, trava de duplicidade e o gate de papel que
// decide o que pode sair por WhatsApp.
export { resumoDiario, indexarAssinante, responderPeloWhatsapp } from './assistente'
